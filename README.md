...
- frontend/chrome-extension: Browser extension application (active implementation)
- backend/api: Backend APIs and integration services
- ai/services: AI service modules (OCR, captioning, assistant)
- shared: Shared contracts and schemas
- infra: CI/CD and deployment assets
- docs: Architecture, legal, and product documentation

## Frontend Commands

Run from frontend/chrome-extension:
